		...
		KpiResult k=KpiResult.getInstance(
				...
				ImmutableList.of(
						PojoRunImpl.builder().
							...
							responseData(ImmutableList.of(PojoResponseDataImpl.of(Millisecond.of(11), false, UserName.JEFF, QuestionType.GroupHow),
						...
						PojoRunImpl.builder().
							countData(ImmutableList.of(PojoCountDataImpl.of("A",11,UserName.JEFF), PojoCountDataImpl.of("B", 22, UserName.TIM))).
							responseData(ImmutableList.of(PojoResponseDataImpl.of(Millisecond.of(11), true, UserName.JEFF, QuestionType.IndividualHow),
